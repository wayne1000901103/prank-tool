...
def run_blue_screen():
    os.system("start CMD-blue-screen.bat")

def run_crash():
    os.system("start CMD-Crash.bat")

def run_popups():
    os.system("start CMD-unlimited-pop-ups.bat")

def run_vbs():
    os.system("start VBS-that-can’t-be-turned-off.vbs")
